...
<body>
    ...
    <div class="bradcam_area breadcam_bg_1">
        <!-- <h3 style="font: 700 36px/1.2 'Poppins', sans-serif; color: #fff;">About Shivoham</h3> -->
    </div>
    <!-- bradcam_area_end -->
...
<!-- ✅ jQuery should come before everything else -->
...
<!-- ✅ Finally your custom main.js (so it sees jQuery + Owl) -->
