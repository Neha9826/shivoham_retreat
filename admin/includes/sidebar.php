        ...
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <div class="collapse" id="about" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="addAbout.php">Add About</a>
                ...
                <div class="collapse" id="cancellation" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="addCancellationPolicy.php">Add Cancellation Policy</a>
                        <a class="nav-link" href="allCancellationPolicies.php">All Cancellation Policies</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="contact" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="contact_info.php">Add Contact Info</a>
                ...
                <div class="collapse" id="nearby" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="addNearby.php">Add Nearby Place</a>
                        <a class="nav-link" href="allNearby.php">All Nearby Places</a>
                    </nav>
                </div>
